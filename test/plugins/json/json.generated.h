...
DEFINE_ARRAY_ELEM_GETTER(str_arr, TYPE_CHAR_PTR_ARR, char * *, char  *)
...
const StructFieldInfo LongString_Metadata[] = {
    { "longstring", TYPE_CHAR_PTR, offsetof(LongString, longstring), sizeof(char *), 1, FIELD_ACCESS_RW, NULL, NULL },
};
